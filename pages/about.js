...
export default function AboutMe() {
    return (
        <div className="w-4/5 mx-auto flex flex-col items-center">
            ...
            <p className=" p-2 m-2 bg-lightgray mb-8">
