import ProgressBar from "../components/Colorfy/ProgressBar"

export default function About() {
    return(
        <div className="w-3/4 mx-auto">
            <h1 className="text-center mb-3">About Colorfy</h1>
            <p className="mb-10">
            &emsp;&emsp; I created colorfy because I love music and colors. <br></br>
